...
**/
class UIApp implements h3d.IDrawable {
    ...
    **/
    ...
    /**
        UI 2D scene.
    **/
    public var ui2d(default,null) : h2d.Scene;
    ...
    **/
    ...
    function setUI2D( ui2d : h2d.Scene, disposePrevious = true ) {
        sevents.removeScene(this.ui2d);
        sevents.addScene(ui2d);
        if( disposePrevious )
            this.ui2d.dispose();
        this.ui2d = ui2d;
        ui2d.mark = mark;
    ...
    **/
    ...
    function mainLoop() {
        ...
        if( ui2d != null ) ui2d.setElapsedTime(dt);
